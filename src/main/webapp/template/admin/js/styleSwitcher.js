function addSwitcher()
{
	...
	var demoPanel = '<div class="dz-demo-panel"> <div class="bg-close"></div>' +
        '<a class="dz-demo-trigger" data-toggle="tooltip" data-placement="right" data-original-title="Check out more demos" href="javascript:void(0)"><span><i class="las la-tint"></i></span></a>' +
        '<div class="dz-demo-inner"> <a href="javascript:void(0);" class="btn btn-primary btn-sm px-2 py-1 mb-3" onclick="deleteAllCookie()">Delete All Cookie</a> <div class="dz-demo-header"> <h3 class="text-white">Select Preset Demo</h3> <a class="dz-demo-close" href="javascript:void(0)"><span><i class="las la-times"></i></span></a> </div>' +
        '<div class="dz-demo-content"> <div class="dz-wrapper row"> <div class="col-xl-3 col-md-6 mb-4"> <div class="overlay-bx rounded-lg dz-demo-bx"> <div class="overlay-wrapper rounded-lg"><img  alt="" class="w-100"></div>' +
        '<div class="overlay-layer"><a href="javascript:void(0);" data-theme="1" class="btn dz_theme_demo btn-secondary btn-sm mr-2">LTR</a><a href="javascript:void(0);" data-theme="1" class="btn dz_theme_demo_rtl btn-info btn-sm">RTL</a></div>' +
        '</div><h5 class="text-white">Demo 1</h5> </div><div class="col-xl-3 col-md-6 mb-4"> <div class="overlay-bx rounded-lg dz-demo-bx"> <div class="overlay-wrapper rounded-lg"><img alt="" class="w-100"></div>' +
        '<div class="overlay-layer"><a href="javascript:void(0);" data-theme="2" class="btn dz_theme_demo btn-secondary btn-sm mr-2">LTR</a><a href="javascript:void(0);" data-theme="2" class="btn dz_theme_demo_rtl btn-info btn-sm">RTL</a></div></div>' +
        '<h5 class="text-white">Demo 2</h5> </div><div class="col-xl-3 col-md-6 mb-4"> <div class="overlay-bx rounded-lg dz-demo-bx"> <div class="overlay-wrapper rounded-lg"><img alt="" class="w-100"></div>' +
        '<div class="overlay-layer"><a href="javascript:void(0);" data-theme="3" class="btn dz_theme_demo btn-secondary btn-sm mr-2">LTR</a><a href="javascript:void(0);" data-theme="3" class="btn dz_theme_demo_rtl btn-info btn-sm">RTL</a></div></div>' +
        '<h5 class="text-white">Demo 3</h5> </div><div class="col-xl-3 col-md-6 mb-4"> <div class="overlay-bx rounded-lg dz-demo-bx"> <div class="overlay-wrapper rounded-lg"><img alt="" class="w-100"></div>' +
        '<div class="overlay-layer"><a href="javascript:void(0);" data-theme="4" class="btn dz_theme_demo btn-secondary btn-sm mr-2">LTR</a><a href="javascript:void(0);" data-theme="4" class="btn dz_theme_demo_rtl btn-info btn-sm">RTL</a></div></div>' +
        '<h5 class="text-white">Demo 4</h5> </div><div class="col-xl-3 col-md-6 mb-4"> <div class="overlay-bx rounded-lg dz-demo-bx"> <div class="overlay-wrapper rounded-lg"><img alt="" class="w-100"></div>' +
        '<div class="overlay-layer"><a href="javascript:void(0);" data-theme="5" class="btn dz_theme_demo btn-secondary btn-sm mr-2">LTR</a><a href="javascript:void(0);" data-theme="5" class="btn dz_theme_demo_rtl btn-info btn-sm">RTL</a></div></div>' +
        '<h5 class="text-white">Demo 5</h5> </div><div class="col-xl-3 col-md-6 mb-4"> <div class="overlay-bx rounded-lg dz-demo-bx"> <div class="overlay-wrapper rounded-lg"><img alt="" class="w-100"></div>' +
        '<div class="overlay-layer"><a href="javascript:void(0);" data-theme="6" class="btn dz_theme_demo btn-secondary btn-sm mr-2">LTR</a><a href="javascript:void(0);" data-theme="6" class="btn dz_theme_demo_rtl btn-info btn-sm">RTL</a></div></div>' +
        '<h5 class="text-white">Demo 6</h5> </div><div class="col-xl-3 col-md-6 mb-4"> <div class="overlay-bx rounded-lg dz-demo-bx"> <div class="overlay-wrapper rounded-lg"><img alt="" class="w-100"></div>' +
        '<div class="overlay-layer"><a href="javascript:void(0);" data-theme="7" class="btn dz_theme_demo btn-secondary btn-sm mr-2">LTR</a><a href="javascript:void(0);" data-theme="7" class="btn dz_theme_demo_rtl btn-info btn-sm">RTL</a></div></div>' +
        '<h5 class="text-white">Demo 7</h5> </div><div class="col-xl-3 col-md-6 mb-4"> <div class="overlay-bx rounded-lg dz-demo-bx"> <div class="overlay-wrapper rounded-lg"><img alt="" class="w-100"></div>' +
        '<div class="overlay-layer"><a href="javascript:void(0);" data-theme="8" class="btn dz_theme_demo btn-secondary btn-sm mr-2">LTR</a><a href="javascript:void(0);" data-theme="8" class="btn dz_theme_demo_rtl btn-info btn-sm">RTL</a></div></div>' +
        '<h5 class="text-white">Demo 8</h5> </div></div></div><div class="fs-14 pt-3"><span class="text-danger">*Note :</span> This theme switcher is not part of product. It is only for demo. you will get all guideline in documentation. please check <a href="javascript:void(0);" class="text-primary">documentation.</a></div></div></div>';
