...
<script>
    ...
    $('#searchAll').on('keydown', function (event) {
        if (event.which === 13) {
    ...
    function paymentInvoice() {
        ...
        data['tongTienHang'] = parseFloat($('.invoice-total:first').text());
        data['tienKhachTra'] = parseFloat($('#invoice-customer-payment').val());
        data['tienThua'] = data['tongTienHang'] - data['tienKhachTra'];
