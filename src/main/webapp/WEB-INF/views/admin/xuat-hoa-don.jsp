    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-7 text-center">
                <h1 class="font-weight-bold" style="border-bottom: 1px solid #000000; padding: 20px; ">HÓA ĐƠN BÁN
                    HÀNG </h1>
            </div>
        </div>
        <div class="row mt-3">
...
<div class="text-right">
    <button id="printf-invoice" class="btn btn-success">In hóa đơn</button>
</div>
<script>
    ...
    function loadHoaDon() {
        $.ajax({
            ...
            success: (response) => {
                ...
                html += `<tr>
                                <th scope="col" colspan="2" class="fs-4">Tổng tiền: \${totalInoivce}</th>
