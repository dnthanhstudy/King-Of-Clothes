...
<div class="khung">
    ...
    <div class="row ms-4">
        <div class="nav flex-column ">
            ...
            <a href="/thong-tin-tich-diem" class="text-decoration-none a mb-3" style="font-size: 18px"><i class="bi bi-piggy-bank-fill me-2"></i> <s:message code="web.ttweb.point"/></a>
